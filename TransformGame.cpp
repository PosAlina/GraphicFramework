...
void TransformGame::Initialize()
{
	...
	//	SimpleMath::Vector4(-4.0f, 8.0f, -2.0f, 1.0f), SimpleMath::Vector4(1.0f, 0.0f, 0.0f, 1.0f),
	//	SimpleMath::Vector4(-4.0f, 15.0f, -4.0f, 1.0f), SimpleMath::Vector4(1.0f, 0.0f, 0.0f, 1.0f),
	//	SimpleMath::Vector4(-2.0f, 8.0f, -4.0f, 1.0f), SimpleMath::Vector4(1.0f, 0.0f, 0.0f, 1.0f),
	//};
	//tri = new TriangleComponent(this, cam, tripoints, L"ground_Tex.png");
	//Components.emplace_back(tri);
	//edge = new EdgeComponent(this, cam);
	box1 = new BoxComponent(this, cam);
	...
	box2 = new BoxComponent(this, cam, points);
	...
	box3 = new BoxComponent(this, cam, points);
	...
	box4 = new BoxComponent(this, cam, points);
	...
	box5 = new BoxComponent(this, cam, points);
	...
	box6 = new BoxComponent(this, cam, points);
	...
	box7 = new BoxComponent(this, cam, points);
	...
	box8 = new BoxComponent(this, cam, points);
	boxes.emplace_back(box8);

	points = new SimpleMath::Vector4[16]{
		SimpleMath::Vector4(4.0f, 5.0f, 1.0f, 1.0f), SimpleMath::Vector4(0.0f, 0.5f, 0.1f, 1.0f),
		SimpleMath::Vector4(4.0f, 5.0f, -1.0f, 1.0f), SimpleMath::Vector4(0.5f, 0.5f, 0.1f, 1.0f),
		SimpleMath::Vector4(5.0f, 5.0f, -1.0f, 1.0f), SimpleMath::Vector4(0.0f, 0.5f, 0.1f, 1.0f),
		SimpleMath::Vector4(5.0f, 5.0f, 1.0f, 1.0f), SimpleMath::Vector4(0.5f, 0.5f, 0.1f, 1.0f),

		SimpleMath::Vector4(4.0f, 2.0f, 1.0f, 1.0f), SimpleMath::Vector4(0.0f, 0.5f, 0.1f, 1.0f),
		SimpleMath::Vector4(4.0f, 2.0f, -1.0f, 1.0f), SimpleMath::Vector4(0.5f, 0.5f, 0.1f, 1.0f),
		SimpleMath::Vector4(5.0f, 2.0f, -1.0f, 1.0f), SimpleMath::Vector4(0.0f, 0.5f, 0.1f, 1.0f),
		SimpleMath::Vector4(5.0f, 2.0f, 1.0f, 1.0f), SimpleMath::Vector4(0.5f, 0.5f, 0.1f, 1.0f),
	};
	box9 = new BoxComponent(this, cam, points);
	...
	box10 = new BoxComponent(this, cam, points);
